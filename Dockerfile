...
RUN CGO_ENABLED=0 GOOS=${TARGETOS:-linux} GOARCH=${TARGETARCH} go build -a -ldflags "-X github.com/khieron/khieron/internal/version.Version=${VERSION}" -o manager cmd/main.go

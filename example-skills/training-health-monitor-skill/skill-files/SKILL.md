...
For each running training job, gather the following information:
...
- **Scheduling failures**: Pods cannot be placed due to insufficient GPU or memory resources.
...
Steps 2-5 should be repeated for each running or failed training job discovered in Step 1.

...
LDFLAGS := -X github.com/khieron/khieron/internal/version.Version=$(VERSION)
...
# khieron.io/khieron-bundle:$VERSION and khieron.io/khieron-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/khieron/khieron
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name khieron-builder
	$(CONTAINER_TOOL) buildx use khieron-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --build-arg VERSION=$(VERSION) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm khieron-builder
	rm Dockerfile.cross
